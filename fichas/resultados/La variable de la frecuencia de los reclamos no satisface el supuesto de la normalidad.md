...
*Conexión con la pregunta de investigación:* el elemento central del proyecto consiste en estudiar la intervención de las variables de la edad del asegurado, la antigüedad con la aseguradora, el historial de siniestros y las características del vehículo, tanto en la frecuencia como en la seve ridad de los siniestros, de forma que se busca determinar la naturaleza de la relación que existe entre las variables descritas. Para realizarlo, se calcula el coeficiente de correlación, sin embargo, es preciso seleccionar la metodología correcta de acuerdo a las características de los datos. En vista de lo anterior, el presente hallazgo cobra una gran importancia.
