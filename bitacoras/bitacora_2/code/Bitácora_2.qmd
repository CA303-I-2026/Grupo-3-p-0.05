...
Una vez completado el tratamiento inicial de la base de datos, se procedió a calcular estadísticas descriptivas para las variables numéricas, utilizando la función stat.desc() del paquete *pastecs* en R.
