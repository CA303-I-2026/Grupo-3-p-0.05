...
-   En la primera bitácora, se aprendió que delimitar bien la pregunta de investigación y organizar el trabajo desde el inicio era esencial para orientar el proyecto.
    En la segunda, se fortaleció la exploración de datos y la interpretación de gráficos, lo cual permitió reconocer patrones importantes en la base.
    En la tercera, se comprendió que R ofrece herramientas útiles para desarrollar análisis más complejos, como el ajuste de distribuciones para estudiar el umbral de 900 euros.
    En la cuarta, se aprendió que la metodología debe revisarse y mejorar conforme avanza el proyecto, especialmente cuando aparecen nuevos resultados o retroalimentaciones.
