...
-   En la tercera bitácora, se pasó de un análisis descriptivo a un enfoque hacia la modelación e inferencia estadística, lo cual representó un salto de complejidad organizativa y comunicativa considerable. 
    En esta bitácora se reforzó el nivel organizativo y comunicativo del grupo y se aprendió a implementar e interpretar resultados estadísticos como los coeficientes de correlación, la comparación entre grupos y el ajuste de distribuciones. Además, se comprendió la importancia de una buena estructuración de la metodología para saber con claridad lo que se está desarrollando.
