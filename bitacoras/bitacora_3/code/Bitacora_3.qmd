...
Una vez cargada y procesada la base de datos, se realiza un análisis descriptivo general con el propósito de conocer la estructura de la información disponible. Esta etapa permite resumir las principales características de los asegurados, los vehículos y el historial de siniestros registrado en la base.
...
omo primer acercamiento a la pregunta de investigación, se resumen las variables asociadas directamente con la frecuencia y la severidad de los siniestros. La frecuencia se representa mediante `N_claims_year`, mientras que la severidad se aproxima con `Cost_claims_year`.
