...
- Los datos se obtuvieron de la Universidad de Valencia, España, de la página Mendeley Data.

- Posee 105.555 observaciones, 53.502 observaciones únicas y 30 variables.

- Variables como "Date_lapse" posee 70.408 NA representando un 66.7% de los datos.

## Base de datos
![](distibucion_costo_anyo.png){height=90%}

## Base de datos
![](Tabla_estadísticos_descriptivos.png)

## Base de datos
![](velas_atipicos.png){height=90%}
